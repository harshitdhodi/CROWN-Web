...
const Footer8 = async () => {
	...
	const description = footerData?.description || "Developing personalze our customer journeys to increase satisfaction & loyalty of our expansion. Wiretex has been a game.";
