						...
						<div className="terms-and-conditions-wrapper">
							<div>
								<h2>
									Terms &amp; Conditions{" "}
									<span className="pill">
										CROWN Packaging – Corporate Business HTML Template
									</span>
								</h2>
								<p className="muted">Last updated: September 9, 2025</p>
								<p>
									Thank you for choosing{" "}
									<strong>CROWN Packaging – Corporate Business HTML Template</strong> .
								...
								<div className="note">
									<strong>Short version:</strong> You can use CROWN Packaging on the
